...
var AvaliacaoExperiencia = /** @class */ (function (_super) {
    ...
    AvaliacaoExperiencia.build = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var avaliacaoExperiencia, avaliacaoExperienciaExistente, transacaoExperiencia;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!data.transacaoExperienciaId) return [3 /*break*/, 3];
                        return [4 /*yield*/, AvaliacaoExperiencia_1.findOne({ where: { transacaoExperienciaId: data.transacaoExperienciaId } })];
                    case 1:
                        avaliacaoExperienciaExistente = _a.sent();
                        if (avaliacaoExperienciaExistente)
                            throw new http_error_1.HttpError('Avaliação de experiência já cadastrada', 409);
                        return [4 /*yield*/, transacao_experiencia_entity_1.TransacaoExperiencia.findOne({ where: { id: data.transacaoExperienciaId } })];
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [2 /*return*/, avaliacaoExperiencia];
                }
            });
        });
    };

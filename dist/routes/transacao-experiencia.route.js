...
transacaoExperienciaRouter.post('/transacao-experiencia', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var transacaoExperiencia;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (req.body.id)
                    return [2 /*return*/, next(new bad_request_error_1.BadRequestError('Transação/Experiência não deve ser especificada'))];
...
transacaoExperienciaRouter.put('/transacao-experiencia', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var transacaoExperiencia;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!req.body.id)
                    return [2 /*return*/, next(new bad_request_error_1.BadRequestError('Transação/Experiência não especificada'))];
                return [4 /*yield*/, transacao_experiencia_entity_1.TransacaoExperiencia.findOne({ where: { id: req.body.id } })];
            case 1:
                transacaoExperiencia = _a.sent();
                if (!transacaoExperiencia)
                    return [2 /*return*/, next(new not_found_error_1.NotFoundError('Transação/Experiência não encontrada'))];
                if (req.body.valor)
...
transacaoExperienciaRouter.get('/cliente/:clienteId/transacoes-experiencias', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var resultSet, transacoesExperiencias;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:

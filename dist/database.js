            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.userRepository = this.connection.getRepository(cliente_entity_1.Cliente);
                        return [2 /*return*/];
                }
            });
        });
    };
    Database.recreateDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.connection.dropDatabase()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.connection.synchronize()];
                    case 2:
                        _a.sent();
